...
import type { ReviewSentiment, ReviewCreateRequest } from "../../types/rental";
...
export default function ReviewCreatePage() {
    ...
    const title = state.title || "데이터구조 전공서적 빌릴 수 있을까요";
    const partnerName = state.partnerName || "책벌레 99";
